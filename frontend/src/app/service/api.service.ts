...
export class ApiService {
  ...
  private _refreshEventRequests$ = new Subject<void>();
  ...
  get refreshEventRequest$() {
    return this._refreshEventRequests$;
  }

  public saveEventRequest(eventRequest: any): Observable<EventRequest> {
    return this.http.post<EventRequest>(`${this.API_URL}/eventRequest`, eventRequest);
  }

  public getEventRequest(): Observable<EventRequest[]> {
    return this.http.get<EventRequest[]>(`${this.API_URL}/eventRequest`);
  }

  public getEventRequestById(uuid: string): Observable<EventRequest> {
    return this.http.get<EventRequest>(`${this.API_URL}/eventRequest/${uuid}`);
  }

  public deleteEventRequest(uuid: string) {
    return this.http.delete<EventRequest>(`${this.API_URL}/eventRequest/${uuid}`).pipe(
      tap(() => {
        this._refreshEventRequests$.next();
      })
    );
  }
}
